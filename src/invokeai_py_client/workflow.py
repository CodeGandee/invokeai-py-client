...
class Workflow:
    ...
    @classmethod
    def from_file(
        cls, client: InvokeAIClient, workflow_path: str | Path
    ) -> Workflow:
        """
    ...
    @classmethod
    def from_dict(
        cls, client: InvokeAIClient, workflow_dict: dict[str, Any]
    ) -> Workflow:
        """
    ...
    def get_input(self, name: str) -> Any | None:
        """
    ...
    async def submit(self, validate: bool = True, priority: int = 0) -> IvkJob:
        """
