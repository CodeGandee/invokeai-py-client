...
class BatchImageGenerator:
        ...
        return {
            ...
            "nodes": {
                ...
                "pos_prompt": {
                    ...
                    "inputs": {"prompt": prompt, "style": style},
                },
                "neg_prompt": {
                    "id": "neg_prompt",
                    "type": "sdxl_compel_prompt",
                ...
                "noise": {
                    "id": "noise",
                    "type": "noise",
                    "inputs": {"width": 1024, "height": 1024, "seed": seed},
                },
                "denoise": {
                    "id": "denoise",
    ...
    def enqueue_generation(self, prompt_info: Dict[str, str]) -> str:
        ...
        graph = self.create_sdxl_graph(prompt_info["prompt"], prompt_info["style"])
    ...
    def wait_for_completion(self, timeout: int = 180) -> bool:
        ...
        while time.time() - start_time < timeout:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"  Queue status - Pending: {queue['pending']}, In Progress: {queue['in_progress']}"
                )
                time.sleep(3)
    ...
    def download_recent_images(self, count: int = 5) -> List[str]:
        ...
        response = self.session.get(
            f"{self.base_url}/api/v1/images/", params={"limit": count, "offset": 0}
        )
